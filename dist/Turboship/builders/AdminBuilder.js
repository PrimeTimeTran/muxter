...
var _AdminHelpers = require("./AdminHelpers.js");
...
class AdminBuilder {
  constructor(entities, options, zip) {
    ...
    this.zip = zip;
    this.root = _path.default.join('nuxt/components/Admin');
  ...
  buildTable() {
    ...
    <script setup>
      ...
      const sortFields = reactive(${(0, _AdminHelpers.buildSortFields)(e)})
      ...
      ${(0, _AdminHelpers.buildEnumeratorHelpers)(e)}
      </script>
      <template>
        <div
          ...
          >
            <thead class="bg-gray-200 dark:bg-neutral-950">
              <tr class="dark:text-black">
                ${(0, _AdminHelpers.buildTableHeaders)(e)}
              </tr>
            </thead>
            <tbody
            ...
            >
              ...
              >
                ${(0, _AdminHelpers.buildTableRows)(e)}
              </tr>
            </tbody>
          </table>
  ...
  buildForm() {
    const content = (0, _AdminHelpers.buildForm)(this.e);
    return content;
  }
  buildEntityForm() {
    const content = (0, _AdminHelpers.buildEntityForm)(this.e);
    return content;
  }
  buildEntityUseHook() {
    const apiUrl = `\`\${apiUrl}/${this.e.plural}\``;
    const capitalized = (0, _helpers.capitalize)(this.e.plural);
    const content = `
    import { ref } from 'vue'
