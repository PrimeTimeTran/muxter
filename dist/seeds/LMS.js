...
export var LMS = [{
  ...
  plural: 'wizards',
  pluralL: 'Wizards',
  tableFields: ['email', 'firstName', 'lastName', 'house', 'topSpells', 'bookAppearances', 'city', 'country', 'jobTitle', 'industry', 'patronus', 'potions', 'charms', 'apparition', 'dada', 'gender', 'fanScore'],
  fields: {
    email: {
      label: 'Email',
      type: 'string',
